...
//import com.example.codeup.springblog.repositories.PostRepositories;
import com.example.codeup.springblog.repositories.PostRepository;
//import com.example.codeup.springblog.repositories.UserRepositories;
...
public class PostsIntegrationTests {
    ...
    public void testShowPost() throws Exception {
        ...
        this.mvc.perform(get("/posts/" + existingPost.getId())
                .session((MockHttpSession) httpSession)) // added the session to the request for viewing post functionality - must be logged in to view post
